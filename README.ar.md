...
لم تُقدَّم عينات X أصلية قابلة للتحقق أو معلومات مصدر، لذلك لا تُعرض `sample-01`–`sample-04`. أما الأعمال الثمانية أدناه فقد أنشأها هذا الـ Panel بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر.
